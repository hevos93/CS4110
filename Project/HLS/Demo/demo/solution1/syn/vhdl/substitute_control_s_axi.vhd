...
entity substitute_control_s_axi is
generic (
...
end entity substitute_control_s_axi;
...
architecture behave of substitute_control_s_axi is
    ...
    signal int_output_r        : UNSIGNED(7 downto 0) := (others => '0');
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_OUTPUT_R_DATA_0 =>
                        rdata_data <= RESIZE(int_output_r(7 downto 0), 32);
