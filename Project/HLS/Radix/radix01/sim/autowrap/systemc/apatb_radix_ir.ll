; ModuleID = 'C:/Users/hevos/Documents/CS4110/Project/HLS/Radix/radix01/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_radix_ir(i8* noalias nocapture nonnull readonly %input, i32 %output) local_unnamed_addr #0 {
entry:
  %input_copy = alloca i8, align 512
  call fastcc void @copy_in(i8* nonnull %input, i8* nonnull align 512 %input_copy)
  call void @apatb_radix_hw(i8* %input_copy, i32 %output)
  call void @copy_back(i8* %input, i8* %input_copy)
  ret void
}
