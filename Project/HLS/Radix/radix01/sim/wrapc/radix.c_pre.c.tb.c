...
extern "C"
#endif
void apatb_radix_ir(const char *, int *);
#ifdef __cplusplus
extern "C"
#endif
void radix_hw_stub(const char *input, int *output){
radix(input, output);
return ;
}
#ifdef __cplusplus
extern "C"
#endif
void apatb_radix_sw(const char *input, int *output){
apatb_radix_ir(input, output);
return ;
}
#endif
# 89 "S:/Dokumenter/Skole/CS-Master/CS4110/Code/radix/radix.c"
