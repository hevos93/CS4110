...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "radix.autotvin.dat"
	set constFileTvOut       "radix.autotvout.dat"
	set constFileHdlTvIn     "radix.autohdltvin.dat"
	set constFileHdlTvOut    "radix.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
