...
set C_modelArgList {
	...
	{ vla13 int 8 regular {array 8 { 0 0 } 0 1 }  }
}
...
set portList { 
	...
	{ vla13_we1 sc_out sc_logic 1 signal 1 } 
	{ vla13_d1 sc_out sc_lv 8 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "vla13_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "vla13", "role": "we1" }} , 
 	{ "name": "vla13_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "vla13", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	...
	vla13 { ap_memory {  { vla13_address0 mem_address 1 3 }  { vla13_ce0 mem_ce 1 1 }  { vla13_we0 mem_we 1 1 }  { vla13_d0 mem_din 1 8 }  { vla13_address1 MemPortADDR2 1 3 }  { vla13_ce1 MemPortCE2 1 1 }  { vla13_we1 MemPortWE2 1 1 }  { vla13_d1 MemPortDIN2 1 8 } } }
}
