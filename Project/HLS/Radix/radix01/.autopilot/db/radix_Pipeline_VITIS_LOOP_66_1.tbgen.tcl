set moduleName radix_Pipeline_VITIS_LOOP_66_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_Pipeline_VITIS_LOOP_66_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_r int 8 regular {array 8 { 1 } 1 1 }  }
	{ vla1 int 8 regular {array 8 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	input_r { ap_memory {  { input_r_address0 mem_address 1 3 }  { input_r_ce0 mem_ce 1 1 }  { input_r_q0 in_data 0 8 } } }
	vla1 { ap_memory {  { vla1_address0 mem_address 1 3 }  { vla1_ce0 mem_ce 1 1 }  { vla1_we0 mem_we 1 1 }  { vla1_d0 mem_din 1 8 } } }
}
