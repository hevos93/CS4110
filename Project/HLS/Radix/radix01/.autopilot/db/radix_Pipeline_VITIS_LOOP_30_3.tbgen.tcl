set moduleName radix_Pipeline_VITIS_LOOP_30_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {radix_Pipeline_VITIS_LOOP_30_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ vla1 int 8 regular {array 8 { 1 1 } 1 1 }  }
	{ place_1 int 32 regular  }
	{ count int 32 regular {array 6 { 2 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "vla1", "interface" : "memory", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ vla1_address0 sc_out sc_lv 3 signal 0 } 
	{ vla1_ce0 sc_out sc_logic 1 signal 0 } 
	{ vla1_q0 sc_in sc_lv 8 signal 0 } 
	{ vla1_address1 sc_out sc_lv 3 signal 0 } 
	{ vla1_ce1 sc_out sc_logic 1 signal 0 } 
	{ vla1_q1 sc_in sc_lv 8 signal 0 } 
	...
	{ count_q0 sc_in sc_lv 32 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "vla1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "vla1", "role": "q0" }} , 
 	...
 	{ "name": "vla1_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "vla1", "role": "q1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sdiv_32ns_32ns_32_36_1_U16", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.srem_32ns_5ns_3_36_1_U17", "Parent" : "0"},
...
set Spec2ImplPortList { 
	vla1 { ap_memory {  { vla1_address0 mem_address 1 3 }  { vla1_ce0 mem_ce 1 1 }  { vla1_q0 in_data 0 8 }  { vla1_address1 MemPortADDR2 1 3 }  { vla1_ce1 MemPortCE2 1 1 }  { vla1_q1 in_data 0 8 } } }
	place_1 { ap_none {  { place_1 in_data 0 32 } } }
	count { ap_memory {  { count_address0 mem_address 1 3 }  { count_ce0 mem_ce 1 1 }  { count_we0 mem_we 1 1 }  { count_d0 mem_din 1 32 }  { count_q0 in_data 0 32 } } }
}
