...
module radix_radix_Pipeline_VITIS_LOOP_26_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln26_fu_62_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln26_fu_62_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
        count_we0 = 1'b1;
    end else begin
        count_we0 = 1'b0;
    end
