...
//------------------------Parameter----------------------
`define TV_IN_input_r "../tv/cdatafile/c.fir.autotvin_input_r.dat"
`define TV_OUT_output_r "../tv/rtldatafile/rtl.fir.autotvout_output_r.dat"
parameter ADDR_WIDTH = 5;
parameter DATA_WIDTH = 32;
parameter input_r_DEPTH = 1;
reg [31 : 0] input_r_OPERATE_DEPTH = 0;
parameter input_r_c_bitwidth = 8;
parameter output_r_DEPTH = 1;
reg [31 : 0] output_r_OPERATE_DEPTH = 0;
parameter output_r_c_bitwidth = 8;
parameter START_ADDR = 0;
parameter fir_continue_addr = 0;
parameter fir_auto_start_addr = 0;
parameter input_r_data_in_addr = 16;
parameter output_r_data_out_addr = 24;
parameter output_r_valid_out_addr = 28;
