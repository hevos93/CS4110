...
extern "C"
#endif
void apatb_fir_ir(const unsigned char, unsigned char *);
#ifdef __cplusplus
extern "C"
#endif
void fir_hw_stub(const unsigned char input, unsigned char *output){
fir(input, output);
return ;
}
#ifdef __cplusplus
extern "C"
#endif
void apatb_fir_sw(const unsigned char input, unsigned char *output){
apatb_fir_ir(input, output);
return ;
}
#endif
# 26 "C:/Users/hevos/Documents/CS4110/VitisHLS/LW3/CS4110-HLS-Tutorial-master/CS4110-HLS-Tutorial-master/src/hls/fir.c"
