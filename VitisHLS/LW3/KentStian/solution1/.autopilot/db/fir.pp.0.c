# 1 "CS4110-HLS-Tutorial-master/CS4110-HLS-Tutorial-master/src/hls/fir.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 359 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "CS4110-HLS-Tutorial-master/CS4110-HLS-Tutorial-master/src/hls/fir.c" 2


# 1 "CS4110-HLS-Tutorial-master/CS4110-HLS-Tutorial-master/src/hls/fir.h" 1
...
# 6 "CS4110-HLS-Tutorial-master/CS4110-HLS-Tutorial-master/src/hls/fir.h" 2

__attribute__((sdx_kernel("fir", 0))) void fir( const uint8_t input, uint8_t* output );
# 4 "CS4110-HLS-Tutorial-master/CS4110-HLS-Tutorial-master/src/hls/fir.c" 2
...
__attribute__((sdx_kernel("fir", 0))) void fir( const uint8_t input, uint8_t* output )
{
#line 15 "C:/Users/hevos/Documents/CS4110/VitisHLS/LW3/KentStian/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fir
# 9 "CS4110-HLS-Tutorial-master/CS4110-HLS-Tutorial-master/src/hls/fir.c"
...
#pragma HLS INTERFACE mode=s_axilite port=output
 ...
 VITIS_LOOP_18_1: for (int8_t i = 3 - 1; i > 0; i--)
 {
