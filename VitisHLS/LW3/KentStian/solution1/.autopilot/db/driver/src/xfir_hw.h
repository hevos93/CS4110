...
#define XFIR_CONTROL_BITS_INPUT_R_DATA  8
#define XFIR_CONTROL_ADDR_OUTPUT_R_DATA 0x18
#define XFIR_CONTROL_BITS_OUTPUT_R_DATA 8
#define XFIR_CONTROL_ADDR_OUTPUT_R_CTRL 0x1c
