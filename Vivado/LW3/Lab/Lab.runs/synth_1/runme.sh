...
HD_PWD='C:/Users/hevos/Documents/CS4110/Vivado/LW3/Lab/Lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mafirfsmd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mafirfsmd.tcl
