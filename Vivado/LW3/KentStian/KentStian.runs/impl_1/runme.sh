...
HD_PWD='C:/Users/hevos/Documents/CS4110/Vivado/LW3/KentStian/KentStian.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log KentStian_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source KentStian_wrapper.tcl -notrace
