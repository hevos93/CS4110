...
HD_PWD='C:/Users/hevos/Documents/CS4110/Vivado/LW3/KentStian/KentStian.runs/KentStian_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KentStian_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KentStian_auto_pc_0.tcl
