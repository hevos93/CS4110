...
HD_PWD='C:/Users/hevos/Documents/CS4110/Vivado/LW1/Nappemann/Nappemann.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log napcipher_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source napcipher_wrapper.tcl -notrace
