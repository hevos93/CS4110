...
HD_PWD='C:/Users/hevos/Documents/CS4110/Vivado/LW1/Nappemann/Nappemann.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log napcipher_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source napcipher_wrapper.tcl
