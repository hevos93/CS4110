...
HD_PWD='C:/Users/hevos/Documents/CS4110/Vivado/LW1/Nappemann/Nappemann.runs/napcipher_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log napcipher_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source napcipher_auto_pc_0.tcl
