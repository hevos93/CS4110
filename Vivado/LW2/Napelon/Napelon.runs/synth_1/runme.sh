...
HD_PWD='C:/Users/hevos/Documents/CS4110/Vivado/LW2/Napelon/Napelon.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cipher_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cipher_wrapper.tcl
