...
HD_PWD='C:/Users/hevos/Documents/CS4110/Vivado/LW2/Napelon/Napelon.runs/cipher_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cipher_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cipher_auto_pc_0.tcl
