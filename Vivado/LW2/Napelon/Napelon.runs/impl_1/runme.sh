...
HD_PWD='C:/Users/hevos/Documents/CS4110/Vivado/LW2/Napelon/Napelon.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cipher_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cipher_wrapper.tcl -notrace
